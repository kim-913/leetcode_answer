...
/*
 * 
Visits each reachable empty land at most once
In worst case, a building can reach all empty lands → O(m * n)
So B buildings each doing O(m * n) BFS
O(B⋅m⋅n), B is the number of buildings
